...
logfolder = 'adaptive/cc_small/{0}'.format(name)
ckp_name = logfolder
cores_per_job = 5
...
#args3[('max-tokens', 'update-freq', 'tokens-per-sample')].append((2048, 128//gpus, 256))
args3[('dropout', 'attention-dropout', 'relu-dropout')] = [(0.0, 0.0, 0.0)]
args3['adaptive-ramp'] = [0.25, 0.1]
args3['adaptive-lossw'] = [1e-3, 1e-2, 1e-4]
