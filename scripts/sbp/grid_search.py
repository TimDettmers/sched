...
cmd = 'OMP_NUM_THREADS=1 fairseq-train --task language_modeling data/wikitext-2 --arch transformer_lm --share-decoder-input-output-embed   --sample-break-mode none --ddp-backend=no_c10d --batch-size 16  --log-format simple --no-save --log-interval 50 --sbp --fp16'
...
args3 = {}
args3['weight-decay'] = [1e-07, 1e-08]
args3['dropout'] = [0.35, 0.2, 0.1]
args3['attention-dropout'] = [0.2, 0.1, 0.05]
