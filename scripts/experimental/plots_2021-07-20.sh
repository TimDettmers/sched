...
#python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/adam/sensitivity_betas.csv --ploty "ppl" --plotx 'adam_betas' --category 'method' --namey 'Valid Perplexity' --title "32-bit vs 8-bit" --swarm --out ~/plots/png/adam/sensi_betas_all.png --categoricalx  --tick-rotation 45
#python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/adam/sensitivity_eps.csv --ploty "ppl" --plotx 'adam_eps' --category 'method' --namey 'Valid Perplexity' --title "32-bit vs 8-bit" --swarm --out ~/plots/png/adam/sensi_eps.png --categoricalx  --tick-rotation 45


python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/8bit/training.csv --ploty "ppl" --plotx 'vectorwise' --category 'use_8bit_training' --namey 'Valid Perplexity' --title "8-bit Training" --swarm --out ~/plots/png/8bit/training.png --categoricalx  

python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/8bit/blockwise.csv --ploty "ppl" --plotx 'use_blockwise' --category 'optim_bits' --namey 'Valid Perplexity' --title "With Stable Embedding" --swarm --out ~/plots/png/8bit/stable.png --categoricalx  --filter stable_emb=True --ylim 16.0 19.0
python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/8bit/blockwise.csv --ploty "ppl" --plotx 'use_blockwise' --category 'optim_bits' --namey 'Valid Perplexity' --title "Without Stable Embedding" --swarm --out ~/plots/png/8bit/nostable.png --categoricalx  --filter stable_emb=False --ylim 16.0 19.0
