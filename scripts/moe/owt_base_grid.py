...
logfolder = 'moe/scaling/owt/{0}'.format(name)
ckp_name = logfolder
#time_hours = 24*2
cores_per_job = 5
...
num_experts = 64
ff_dim = 32*1024
moe_ff_dim = 32*1024//num_experts
heads = 8
model_dim = 512
...
if not args.baseline:
    ...
    args3[key].append((model_dim, 32*1024, 32*1024//num_experts, heads, 0, model_dim, model_dim, num_experts))
    args3[key].append((model_dim, 64*1024, 64*1024//num_experts, heads, 0, model_dim, model_dim, num_experts))
...
args3[('max-update', 'warmup-updates', '')] = [(33888, 3000, ' data/owt')]
