...
#python plot_data.py --csv ~/plots/csv/moe/scaling/cc_news/baselines_segments.csv --ploty "ppl" --plotx 'arch' --category 'decoder_embed_dim' --categoricalx --namey 'Valid Perplexity' --title "PPL Baselines vs Segmented MoE" --swarm --out ~/plots/png/moe/scaling/wt/cc_news_baselines_segments.png
...
python plot_data.py --csv ~/plots/csv/moe/scaling/wt/eval_ppl.csv --ploty "ppl" --plotx 'sample_type' --category "decoder_embed_dim" --categoricalx --namey 'Valid Perplexity' --title "PPL vs Sample Type - WT103" --swarm --filter data=data/wikitext-103 --out ~/plots/png/moe/scaling/wt/gate_type_wt103.png
python plot_data.py --csv ~/plots/csv/moe/scaling/wt/eval_ppl.csv --ploty "ppl" --plotx 'sample_type' --category "decoder_embed_dim" --categoricalx --namey 'Valid Perplexity' --title "PPL vs Sample Type - WT50" --swarm --filter data=data/wikitext-50 --out ~/plots/png/moe/scaling/wt/gate_type_wt50.png
python plot_data.py --csv ~/plots/csv/moe/scaling/wt/eval_ppl.csv --ploty "ppl" --plotx 'sample_type' --category "decoder_embed_dim" --categoricalx --namey 'Valid Perplexity' --title "PPL vs Sample Type - WT25" --swarm --filter data=data/wikitext-25 --out ~/plots/png/moe/scaling/wt/gate_type_wt25.png
