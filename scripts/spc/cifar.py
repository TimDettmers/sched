...
logfolder = 'spc/{0}'.format(name)
ckp_name = logfolder
#time_hours = 24*2
cores_per_job = 5
mem = 128*(8 if gpus > 8 else gpus)
mem = None
num_seeds = 1
seed_offset = 0
time_hours = 0
...
partition = 'batch'
change_dir = 'spc_optimizers'
repo = 'spc_optimizers'
exclude = ''

s = gpuscheduler.HyakScheduler(verbose=args.verbose, account='csc652', partition=partition, use_gres=False)
