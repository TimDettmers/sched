...
args3['weight-decay'] = [0.1]

#args3['attention-bmm-bits'] = ['16,16,16']
args3['attention-norm'] = [False]
#args3['sparse-perc'] = [1, 2, 3, 5, 10]
#args3['num-splits'] = [2]
#args3['attention-bmm-bits'] = ['16,16,16']
#args3['attention-func'] = ['hardtanh', 'hardswish', 'elu', '""']
#args3['attention-func'] = ['logistic']
#args3['attention-8bit'] = ['linear']
#args3['sparse-decomp-val'] = [6.0, 5.0, 4.0]

args3[('attention-8bit', 'sparse-decomp')] = [('linear', True), ('off', False), ('off', True)]
args3['ff-block'] = ['8bit']
args3['sparse-decomp-val'] = [6.0]
#args3['quant-type'] = ['vector', 'row', 'linear']
#args3['quant-type'] = ['row-zeropoint', 'row', 'vector-zeropoint']
args3['quant-type'] = ['row']
