...
cmd = 'OMP_NUM_THREADS=1 python train.py --cuda --data ../data/wikitext-2/ --dataset wt103 --adaptive --n_layer 12 --optim adam --tgt_len 150 --mem_len 150 --eval_tgt_len 150 --fp16 --dynamic-loss-scale --eval-interval 500 --log-interval 150'
...
logfolder = 'multifilter/{0}/'.format('baseline_full')
time_hours = 2
cores_per_job = 5
num_seeds = 8
...
#args3['d_head'] = [40]
args3['lr'] = [0.0006]
args3['max_step'] = [6000, 9000]
args3['warmup_step'] = [800]
#args3['d_model'] = [400]
#args3['d_head'] = [20]
#args3['n_head'] = [1]
#args3['dropout'] = [0.0]#, 0.15, 0.2]
#args3['dropatt'] = [0.0, 0.1]
args3['dropout'] = [0.1, 0.15]
args3['batch_size'] = [32]
#args3['filter-std'] = [15]
#args3['index-std'] = [0.5, 1]
#args3['num-filters'] = [150]
#args3['filter-size'] = [5, 10]
