...
cmd = 'python -m torch.distributed.launch --master_port 12347 --nproc_per_node=8       train.py       --data-dir /datasets01/imagenet_full_size/061417/ --dataset imagenet       --nce-k 65536       --amp-opt-level O3 '
args2 = {}
...
change_dir = '/private/home/timdettmers/git/bl0/moco/'
repo = 'bl0/moco'
exclude = ''
