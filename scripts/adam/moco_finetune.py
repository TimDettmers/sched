...
parser.add_argument('--ckppath', type=str)
...
#cmd = ' python main_moco.py  -a resnet50  --lr 0.03  --batch-size 256  --dist-url "tcp://localhost:10001" --multiprocessing-distributed --world-size 1 --rank 0 /datasets01/imagenet_full_size/061417/'
cmd = 'python main_lincls.py  -a resnet50  --lr 30.0  --batch-size 256  --dist-url "tcp://localhost:10001" --multiprocessing-distributed --world-size 1 --rank 0  /datasets01/imagenet_full_size/061417/'
args2 = {}
...
#args3['pretrained'] =  ('{0}/checkpoint_0199.pth.tar']

for log_name in pathlib.Path(args.ckppath).rglob('*checkpoint_0199.pth.tar'):
    print(log_name)
