...
python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/adam/8bit.csv --ploty "ppl" --plotx 'lr' --category 'adam_bits' --namey 'Valid Perplexity' --title "PPL vs Learning Rate" --swarm --out ~/plots/png/adam/lr.png --categoricalx
python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/adam/8bit.csv --ploty "ppl" --plotx 'adam_betas' --category 'adam_bits' --namey 'Valid Perplexity' --title "PPL vs Adam Betas" --swarm --out ~/plots/png/adam/betas.png --categoricalx
python /private/home/timdettmers/git/sched/plot_data.py --csv ~/plots/csv/adam/8bit.csv --ploty "ppl" --plotx 'adam_eps' --category 'adam_bits' --namey 'Valid Perplexity' --title "PPL vs Adam eps" --swarm --out ~/plots/png/adam/eps.png --categoricalx
