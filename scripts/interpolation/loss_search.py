...
args3['layers'] = [1]
args3['input-drop'] = [0.0]
args3['dropout'] = [0.0, 0.2]
args3[''] = ['norm']
args3['batch-size'] = [128]
#args3['max-variation'] = ['dropout','decoder_embed_dim', 'decoder_ffn_embed_dim','decoder_layers']
#args3['exclude-variation'] = ['""']

#args3['exclude-variation'] = ['dropout', '""']
