...
#args3[('max-tokens', 'update-freq', 'tokens-per-sample')].append((2048, 2, 512))
args3[('dropout', 'attention-dropout', 'relu-dropout')] = [(0.0, 0.0, 0.0)]
args3['str-loss'] = [0.1]
args3['str-progress-start'] = [0.0, 0.2, 0.4, 0.6, 0.8]
args3['target-sparsity'] = [0.8, 0.9]
#args3['str-type'] = ['vector', 'matrix']
args3['str-type'] = ['scalar']
#args3['str-init'] = [-40.0]
